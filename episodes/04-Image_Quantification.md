...
Common software to segment volumetric data include [FSL](https://fsl.fmrib.ox.ac.uk/fsl/fslwiki), [SPM](https://www.fil.ion.ucl.ac.uk/spm) and [ANTS](https://stnava.github.io/ANTs). One of the most used software to segment surface data (in addition of volumetric data) is [Freesurfer](https://surfer.nmr.mgh.harvard.edu). In this episode, we will use the outputs generated by [smriprep](https://github.com/nipreps/smriprep)/[fmriprep](https://github.com/nipreps/fmriprep), which are workflows relying on all these software to generate a large variety of segmentation outputs.
